function gerarEspaçoDiv() {
  const espaçoDiv = '<div class="row justify-content-center" style="margin-top: 15rem;margin-bottom: 5rem;">';
  espaçoDiv += '<div class="card">';
  espaçoDiv += '<div id="dadosDeUsuario" class="card-header"></div>';
  espaçoDiv += '<ul class="list-group list-group-flush" style="text-align: center;">';
  espaçoDiv += '<p><h5>Código-fonte:</h5>';
  espaçoDiv += '</p><li class="list-group-item" style="max-width: 40rem;">';
  espaçoDiv += '<textarea name="CaixaResultado" id="codigoFonte" cols="60" rows="3" style=""></textarea></li>'
  espaçoDiv += '<li class="list-group-item">';
  espaçoDiv += '<a href="" onclick="copiar()" class="btn btn-primary">Copiar o texto</a>';
  espaçoDiv += '</li></ul></div></div>';
  
  document.querySelector('#resultado').innerHTML = espacoDiv;
...
function adicionarValor() {
  ...
  document.querySelector('#resultado').innerHTML = espacoDiv;
  document.getElementById("dadosDeUsuario").innerHTML = result;
